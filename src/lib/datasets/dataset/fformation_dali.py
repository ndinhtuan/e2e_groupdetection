...
class ExternalInputIterator(object):
    def __init__(self, opt, root, paths, img_size=(1088, 608), augment=False, transforms=None, batch_size=32):
        self.opt = opt
    ...
    def __next__(self):
        ...
        # return ret
        print("SHAPE", imgs.shape, hm.shape, reg_mask.shape, ind.shape, wh.shape, reg.shape, bbox_xys.shape, fformation.shape)
        return imgs, hm
