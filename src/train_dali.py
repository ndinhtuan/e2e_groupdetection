...
from datasets.dataset.fformation_dali import ExternalInputIterator
...
def main(opt):
    ...
    eii = ExternalInputIterator(opt, dataset_root, trainset_paths, (1088, 608), augment=True, transforms=transforms)
    pipe = Pipeline(batch_size=opt.batch_size,
    ...
    # import numpy as np
    # print(np.array(labels.as_tensor()))
    # print(np.array(labels.as_tensor()))
